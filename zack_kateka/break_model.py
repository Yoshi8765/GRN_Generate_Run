...
"""
This file will remove connections from your network. Here, remove_connections is a list of tuples. Each tuple is of the form (Source, Target), and represents
...
a new CSV for the broken model in your working directory. Run this script when you set remove_connections.
"""
